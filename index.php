	...
	<br>
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <a href="https://mis.cvchd7.com/dts" target="_blank">
              <div class="box wow fadeInLeft">
          ...
          <div class="col-lg-4">
            <a href="https://mis.cvchd7.com/calendar/login" target="_blank">
              <div class="box wow fadeInLeft" data-wow-delay="0.2s">
          ...
          <div class="col-lg-4">
            <a href="https://intranet.cvchd7.com/intranet/login.php" target="_blank">
              <div class="box wow fadeInRight">
          ...
          <div class="col-lg-4">
            <a href="http://49.157.74.3/ppmp" target="_blank">
              <div class="box wow fadeInRight" data-wow-delay="0.2s">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <!--   <a href="http:///dtr" target="_blank"> -->
             <a href="http://49.157.74.3/dtr" target="_blank">
              <div class="box wow fadeInLeft">
          ...
          <div class="col-lg-4">
           <!--  <a href="http:///pis" target="_blank"> -->
            <a href="http://49.157.74.3/pis" target="_blank">
              <div class="box wow fadeInRight">
